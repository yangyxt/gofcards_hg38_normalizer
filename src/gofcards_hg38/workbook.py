    ...
    out = pd.DataFrame(
        {
            ...
            "hg19_ref": core["Ref"],
            "hg19_alt": core["Alt"],
            "hg19_vcf_pos": core["hg19_VCF_Pos"],
            "hg19_vcf_ref": core["hg19_Ref_for_vep"],
            "hg19_vcf_alt": core["hg19_Alt_for_vep"],
            "hg19_vcf_status": core["hg19_vcf_status"],
            "hg38_chrom": core["hg38_Chr"],
            "hg38_start": core["hg38_Start"],
            "hg38_end": core["hg38_End"],
            "hg38_ref": core["Ref"],
            "hg38_alt": core["Alt"],
            "hg38_vcf_pos": core["hg38_VCF_Pos"],
            "hg38_vcf_ref": core["hg38_Ref_for_vep"],
            "hg38_vcf_alt": core["hg38_Alt_for_vep"],
    ...
    out = pd.DataFrame(
        {
            ...
            "hg19_ref": merged["Ref"],
            "hg19_alt": merged["Alt"],
            "hg19_vcf_pos": merged["hg19_VCF_Pos"],
            "hg19_vcf_ref": merged["hg19_Ref_for_vep"],
            "hg19_vcf_alt": merged["hg19_Alt_for_vep"],
            "hg19_vcf_status": merged["hg19_vcf_status"],
            "hg38_chrom": merged["hg38_Chr"],
            "hg38_start": merged["hg38_Start"],
            "hg38_end": merged["hg38_End"],
            "hg38_ref": merged["Ref"],
            "hg38_alt": merged["Alt"],
            "hg38_vcf_pos": merged["hg38_VCF_Pos"],
            "hg38_vcf_ref": merged["hg38_Ref_for_vep"],
            "hg38_vcf_alt": merged["hg38_Alt_for_vep"],
